...
class InfoWorkbench ( Workbench ):
    "Info workbench object"
    Icon = """
/* XPM */
...
"""
    MenuText = "Info"
    ToolTip = "Info workbench"
    def Initialize(self):
	import InfoCommands
	self.appendToolbar("InfoTools",['Information'])
        self.appendMenu('Info',['Information'])
        ###self.appendCommandbar("&Generic Tools",["ColorCodeShape"])
    def GetClassName(self):
        #return "InfoGui::Workbench"
        return "Gui::PythonWorkbench"

Gui.addWorkbench(InfoWorkbench())
